...
function CommentUtil(props) {
  ...
  useEffect(() => {
    axios
      .get("http://223.130.138.44/reply/islike/" + props.commentNo)
      .then((response) => {
  ...
  const handleLike = () => {
    ...
    if (isLike) {
      axios
        .delete("http://223.130.138.44/reply/like/" + props.commentNo)
        .then((response) => {
      ...
      axios
        .post(
          "http://223.130.138.44/reply/like",
          {},
          {
            params: {
  ...
  function CommentDel() {
    axios
      .delete(`http://223.130.138.44/reply/delete/${props.commentNo}`)
      .then((response) => {
  ...
  useEffect(() => {
    axios
      .get(`http://223.130.138.44/reply/like/${props.commentNo}`)
